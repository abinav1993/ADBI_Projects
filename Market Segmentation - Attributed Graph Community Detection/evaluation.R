...
# ===== Reading the graph ====== #
setwd("C:/Users/Abinav/Google Drive/2nd Semester/BI/Projects/Project - 6/06.Topic-7.Project-6.MarketSegmentation.AttributedGraphCommunityDetection/")
...
for (i in 1:length(lines)){
    ...
    verts = as.integer(verts)  + 0   # R indexes start at 1
    comm[verts] = i
}
close(conn)
